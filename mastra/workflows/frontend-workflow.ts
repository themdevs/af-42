...
const fetchFrontend = createStep({
	id: 'fetch-weather',
	description: 'Fetches frontend details for a given city',
	inputSchema: z.object({
		city: z.string().describe('The city to get the frontend details for'),
	}),
...
const frontendWorkflow = createWorkflow({
